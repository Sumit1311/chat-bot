...
class Customer extends Client{
    ...
    leave(){
        ...
        if(this.room){
            this.socket.to(this.room).emit("message", "Customer "+this.getId()+" has left the chat");
            this.socket.to(this.room).emit("message", "Please select new customer to begin chat");
