    ...
    constructor(socket){
        ...
        this.onMessage((message) => {
            if(message == "::leavechat"){
                ...
                this.socket.to(this.agentRoom).emit("agent-message", "Agent "+this.id+" has left the chat");
                this.socket.to(this.agentRoom).emit("agent-message", "Please refresh to rejoin queue");
